...
class PGD(Attack):
    ...
    def inference(self, data_dict, attack, attack_src, delete_list = [], num = 0, shift_feature = False, rotate_feature = False, attack_conf = None, real_data_dict = None, if_erase = False, erase_index = [], attack_target = 'pred', pred_gt_box_tensor = None, dataset = None, shift_dir_of_box = [], if_inference = True, gt_box_tensor = None, cls = None): 
